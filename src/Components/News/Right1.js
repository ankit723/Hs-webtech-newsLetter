    ...
    <>
      ...
      <Container style={{ padding: "10px" }}>
        {props.data.filter( (fil) => fil.item === props.type ).map((news) => (
          <Row className='d-flex' key={news._id}>
            {/* <Col className='' xs={4}> */}
            ...
            <Col className='d-flex p-0'>
              <img className='' src={`http://localhost:5000/uploads/${news.image}`} alt="FooterDemoImage" style={{ objectFit: "contain", aspectRatio: "1.53", width: "40%" }} />
              <Card style={{ width: '100%', backgroundColor: "transparent", color: "#ffffff", border: "0px" }}>
                <Card.Body style={{ backgroundColor: "transparent", border: "0px", paddingTop: "0" }}>
                  ...
                  <Card.Text style={{ color: "black", fontSize: "12px", fontWeight: "500", width: "auto", height: "auto" }}>
                    {news.head}
                  </Card.Text>
