                ...
                {priority.filter((name) => name.category === category).map((news) => (
                    <Row className='d-flex mb-5'>
                        ...
                        <Col className='d-flex'>
                            <img className='my-auto' src={news.img} alt="FooterDemoImage" style={{ "float": "left", width: "40%", minHeight: "91.219px", minWidth: "140.344px", aspectRatio: "1.53", objectFit: "cover" }} />
